defmodule BlockScoutWeb.AddressView do
  ...
  def address_name_hook(%Hash{} = hash) do
      string_hash = to_string(hash)
      case string_hash do
         "0x00000000000000000000000000000000000a4b05" -> "EcoOS"
         "0x0000000000000000000000000000000000000064" -> "EcoSys"
         "0x0000000000000000000000000000000000000065" -> "EcoInfo"
         "0x0000000000000000000000000000000000000066" -> "EcoAddressTable"
         "0x0000000000000000000000000000000000000067" -> "EcoBLS"
         "0x0000000000000000000000000000000000000068" -> "EcoFunctionTable"
         "0x0000000000000000000000000000000000000069" -> "EcoosTest"
         "0x000000000000000000000000000000000000006b" -> "EcoOwnerPublic"
         "0x000000000000000000000000000000000000006c" -> "EcoGasInfo"
         "0x000000000000000000000000000000000000006d" -> "EcoAggregator"
         "0x000000000000000000000000000000000000006e" -> "EcoRetryableTx"
         "0x000000000000000000000000000000000000006f" -> "EcoStatistics"
         "0x0000000000000000000000000000000000000070" -> "EcoOwner"
         "0x00000000000000000000000000000000000000c8" -> "NodeInterface"
         "0x00000000000000000000000000000000000000c9" -> "NodeInterfaceDebug"
         "0x00000000000000000000000000000000000000ff" -> "EcoDebug"
         _ -> string_hash
    end
  end
